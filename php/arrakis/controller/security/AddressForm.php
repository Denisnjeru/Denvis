...
class AddressForm extends \arrakis\controller\LoggedInController{
   ...
   public function __construct() {
        ...
        $this->model = new \arrakis\model\security\AddressForm();

    }

    public function viewAction() {
        $view = new \arrakis\view\security\AddressForm($this); //this instatiates a view
