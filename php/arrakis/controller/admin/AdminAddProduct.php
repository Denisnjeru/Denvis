...
class AdminAddProduct extends Admin{
    ...
    public function __construct($url) {
        ...
        $id = $url[1];
        $this->model = new \arrakis\model\admin\AdminAddProduct($id);
    ...
    public function viewAction() {
        $view = new \arrakis\view\admin\AdminAddProduct($this); //this instatiates a view
        $view->page();
    }
