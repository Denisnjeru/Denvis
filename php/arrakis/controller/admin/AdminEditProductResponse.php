...
class AdminEditProductResponse extends Admin{
    
    public function __construct() {
       parent::__construct();
       
       
       $r = "\arrakis\controller\admin\AdminEditProduct";
       ...
       $this->model = new \arrakis\model\admin\AdminEditProductResponse ($id, $catid, $name, $image, $gst, $price, $weightd, $unit, $stock, $desc, $lows, $highs, $active);
