...
class AdminAddProduct extends \arrakis\view\View{
    
    
public function section($model) { 
$ctrl = "arrakis\controller\admin\AdminAddProduct";
                    ...
                    <div class="admin-table-wrapper">	                        
                        <div class="account" style="">
                                ...
                                <div id="response" class="form-group"></div>
                                   <form action="/" id="addProduct" novalidate="novalidate"> 
                                       <div class="row">
                                       <div class="col-md-6">
                                        ...
                                        <label for="name"><i class="icon-user"></i> <b>Product name</b></label>
                                                <input class="form-control" id="register-email" type="text" placeholder="" value="" name="<?= $ctrl::FORM_PRODUCT_NAME?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="productUrl"><i class="icon-user"></i> <b>Product URL</b></label>
                                                <input class="form-control" id="register-type" type="text" placeholder="Eg. product-name"  value="" name="<?= $ctrl::FORM_PRODUCT_URL?>">
                                        <p style="font-size: 0.7em">Unique identifier, please make sure you type in the url correctly.</p>
                                        </div>
                                       <div class="form-group">
                                       <label for="categoryUrl"><i class="icon-user"></i> <b>Category URL</b></label>
                                                <input class="form-control" id="register-type" type="text" name="" placeholder=""  value="<?= $model->getCategoryId() ?>" readonly >
                                       <p style="font-size: 0.7em">Unique identifier, it is not possible to edit this field.</p> 
                                        ...
                                        <label for="register-name"><i class="icon-user"></i> <b>Image URL</b></label>
                                                <input class="form-control" id="register-name" type="text" placeholder="Eg. products/product-image"  value=""  name="<?= $ctrl::FORM_PRODUCT_IMAGE?>" >
                                        </div>
                                        <div class="form-group">
                                        <label for="description"><i class="icon-user"></i> <b>Description</b></label>
                                        <textarea class="form-control" id="description"  rows="9" placeholder=""    name="<?= $ctrl::FORM_PRODUCT_DESCRIPTION?>"  ></textarea>
                                        </div>
                                       <div class="form-group">
                                        <label class="checkbox">Active product
                                                <input id="" type="checkbox" name="<?= $ctrl::FORM_PRODUCT_ACTIVE?>"  value="" checked >                                       <p style="font-size: 0.7em">If you uncheck the box the product will not be displayed.</p>				
                                        </label>
                                        </div>
                                       </div>
                                       ...
                                       <div class="col-md-6">
                                        ...
                                        <label for="price"><i class="icon-user"></i> <b>Unit Price</b></label>
                                                <input class="form-control" id="register-name" type="number" placeholder=""  value=""  name="<?= $ctrl::FORM_PRODUCT_PRICE?>"  >
                                        <p style="font-size: 0.7em">Input price per one unit before GST.</p>
                                        </div>
                                        <div class="form-group">
                                        <label for="unit"><i class="icon-user"></i> <b>Unit</b></label>
                                                <input class="form-control" id="register-name" type="text" placeholder=""  value=""  name="<?= $ctrl::FORM_PRODUCT_UNIT?>" >
                                        ...
                                        <label for="weight"><i class="icon-user"></i> <b>Default Pack Weight/Size</b></label>
                                                <input class="form-control" id="register-name" type="number" placeholder=""  value=""  name="<?= $ctrl::FORM_PRODUCT_WEIGHT_DEFAULT?>">
                                        ...
                                        <label for="gst"><i class="icon-user"></i> <b>Gst</b></label>
                                                <input class="form-control" id="register-name" type="number" placeholder=""  value=""  name="<?= $ctrl::FORM_PRODUCT_GST?>">
                                        </div>
                                        <div class="form-group">
                                        <label for="Stock"><i class="icon-user"></i> <b>Units in stock</b></label>
                                                <input class="form-control" id="register-email" type="number" placeholder="" value="" name="<?= $ctrl::FORM_PRODUCT_STOCK?>"  >
                                        <p style="font-size: 0.7em">Total of units in stock.</p>
                                        </div>
                                        <div class="form-group">
                                        <label for="Lowstock"><i class="icon-user"></i> <b>Low Stock</b></label>
                                                <input class="form-control" id="low-stock" type="number" placeholder=""  value=""  name="<?= $ctrl::FORM_PRODUCT_LOW_STOCK?>"  >
                                        </div>
                                       <div class="form-group">
                                       <label for="HighStock"><i class="icon-user"></i> <b>High Stock</b></label>
                                       <input class="form-control" id="high-stock" type="number" placeholder=""  value="" name="<?= $ctrl::FORM_PRODUCT_HIGH_STOCK?>"  >
                                        </div>                                       
                                        <div class="form-group">                                
           ...
           if(validInput)
                {
                    ...
                    var posting = $.post("<?= PROJECT_URL ?>admin-add-product-response",formData);
